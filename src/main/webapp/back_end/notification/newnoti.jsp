...
<%
	NotificationListVO notiVO = (NotificationListVO) request.getAttribute("notiVO");
%>
...
<body>
	...
	<div class="display-a">
		...
		<div class="unique">
			...
			<h4>
				<a
					href="<%=request.getContextPath()%>/back_end/notification/noti_select_page.jsp">回首頁</a>
			</h4>
			<br>
			...
			<form method="post" action="<%=request.getContextPath()%>/NotiServlet">
				...
				<label>會員編號:</label>
				<input type="text" name="memberId" value="<%=(notiVO == null) ? "" : notiVO.getMember().getMemberId()%>">
				<br>
				...
				<label>消息標題:</label>
				<input type="text" name="title" value="<%=(notiVO == null) ? "" : notiVO.getTitle()%>">
				<br>
				
				<label>消息內容:</label>
				<input type="text" name="content" value="<%=(notiVO == null) ? "" : notiVO.getContent()%>">
				<br>
