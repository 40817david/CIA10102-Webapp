		...
		<div class="unique">
			...
			<form method="post" action="<%=request.getContextPath()%>/member.do"
				...
				<table>
					...
					<tr>
						...
						<td><input type="text" name="email"
							value="<%=memVO.getEmail()%>"></td>
					</tr>

					<tr>
						<td>會員名稱:<font color=red><b>*</b></font></td>
						<td><input type="text" name="memberName"
							value="<%=memVO.getMemberName()%>"></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" id="f_date1" name="birthday"
							value="<%=memVO.getBirthday()%>"></td>
					</tr>
				...
				<input type="hidden" name="memberId"
					value="<%=memVO.getMemberId()%>"> <input type="submit"
					value="送出修改">
